# Nolan McMahon Engineering Portfolio
...
GitHub will provide the public portfolio URL after deployment.

## Local preview

Open `index.html` directly, or serve the folder with any simple static web server.
